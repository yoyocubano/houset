export const translations = {
  es: {
    nav: {
      services: "Servicios",
      artisans: "Red de Artesanos",
      about: "Nosotros"
    },
    hero: {
      title: "Tu Espacio Ideal en Luxemburgo",
      subtitle: "Boutique de diseño de interiores. Conectamos clientes con los mejores artesanos certificados y materiales premium en todo el país.",
      btnCatalog: "Ver Catálogo Premium",
      btnConsult: "Agendar Asesoría Gratuita",
      trust: "Más de 50 artesanos certificados en la red B2B"
    },
    services: {
      title: "Nuestros Servicios Premium",
      cards: [
        { title: "Compra de Materiales", desc: "Acceso exclusivo a proveedores europeos de alta gama." },
        { title: "Proyecto Llave en Mano", desc: "Desde el diseño 3D hasta la ejecución final." },
        { title: "Red de Artesanos", desc: "Solo trabajamos con profesionales certificados en Luxemburgo." }
      ]
    },
    catalog: {
  ...
  fr: {
    nav: {
      services: "Services",
      artisans: "Réseau d'Artisans",
      about: "À Propos"
    },
    hero: {
      title: "Votre Espace Idéal au Luxembourg",
      subtitle: "Boutique de design d'intérieur. Nous connectons les clients avec les meilleurs artisans certifiés et des matériaux premium dans tout le pays.",
      btnCatalog: "Voir le Catalogue Premium",
      btnConsult: "Réserver une Consultation Gratuite",
      trust: "Plus de 50 artisans certifiés dans le réseau B2B"
    },
    services: {
      title: "Nos Services Premium",
      cards: [
        { title: "Achat de Matériaux", desc: "Accès exclusif aux fournisseurs européens haut de gamme." },
        { title: "Projet Clé en Main", desc: "De la conception 3D à l'exécution finale." },
        { title: "Réseau d'Artisans", desc: "Nous travaillons uniquement avec des professionnels certifiés au Luxembourg." }
      ]
    },
    catalog: {
  ...
  en: {
    ...
    hero: {
      title: "Your Ideal Space in Luxembourg",
      subtitle: "Interior design boutique. We connect clients with the best certified craftsmen and premium materials across the country.",
      btnCatalog: "View Premium Catalog",
      btnConsult: "Book Free Consultation",
      trust: "Over 50 certified craftsmen in the B2B network"
    },
    services: {
      title: "Our Premium Services",
      cards: [
        { title: "Material Purchasing", desc: "Exclusive access to high-end European suppliers." },
        { title: "Turnkey Project", desc: "From 3D design to final execution." },
        { title: "Artisan Network", desc: "We only work with certified professionals in Luxembourg." }
      ]
    },
    catalog: {
  ...
  lu: {
    nav: {
      services: "Servicer",
      artisans: "Handwierker Netzwierk",
      about: "Iwwer Eis"
    },
    hero: {
      title: "Ären idealen Raum zu Lëtzebuerg",
      subtitle: "Bannenarchitektur Boutique. Mir verbannen Clienten mat de beschten zertifizéierten Handwierker a Premiummaterialien am ganze Land.",
      btnCatalog: "Premium Katalog kucken",
      btnConsult: "Gratis Berodung buchen",
      trust: "Iwwer 50 zertifizéiert Handwierker am B2B Netzwierk"
    },
    services: {
      title: "Eis Premium Servicer",
      cards: [
        { title: "Materialkaaf", desc: "Exklusiven Zougank zu héichwäertegen europäesche Liwweranten." },
        { title: "Schlëssel fäerdeg Projet", desc: "Vum 3D Design bis zur finaler Ausféierung." },
        { title: "Handwierker Netzwierk", desc: "Mir schaffen nëmme mat zertifizéierte Fachleit zu Lëtzebuerg." }
      ]
    },
    catalog: {
